namespace LoggingKata
{
    ...
    public class TacoParser
    {
        ...
        public ITrackable Parse(string line)
        {
            ...
            var latutude = double.Parse(cells[0]);
            // Yovu're going to need to parse your string as a `double`
            ...
            Point latAndLong = new Point() { Latitude = latutude, Longitude = longitude };
